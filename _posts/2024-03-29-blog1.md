...
date: 2014-03-29 
author: kathi-lauer #write the author name id from _authors. Add new author to _author folder if needed. This field is only applicable for hosts and admins
...
image: '/images/blog-banner-kathi.png' #write image path, e.g. '/images/22.jpg'
